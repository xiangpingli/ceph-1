...
namespace librados
{
  ...
  public:
    ...
    int repair_read(const std::string& oid, bufferlist& bl, size_t len, uint64_t off, int32_t osdid, uint32_t e);
    ...
    int aio_repair_read(const std::string& oid, AioCompletion *c,
		 bufferlist *pbl, size_t len, uint64_t off, uint64_t snapid, int32_t osdid, uint32_t e);
    /**
