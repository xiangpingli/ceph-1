...
struct librados::IoCtxImpl {
  ...
  int repair_read(const object_t&, ceph::bufferlist&, size_t, uint64_t, int32_t, epoch_t);
  ...
  int operate_repair_read(const object_t& oid, ::ObjectOperation *o, bufferlist *pbl, int flags, int32_t osdid, epoch_t e);
